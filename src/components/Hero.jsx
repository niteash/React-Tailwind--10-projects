  ...
  return (
    ...
    <Container>
      <main className="h-full  hover:last-child:text-red w-full p-10 bg-black text-white grid sm:grid-cols-1 cursor-pointer lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 ">
        <div className="m-10">
          <h1 className="font-extrabold text-4xl lg:text-7xl sm:mb-8 mb-5 text-left transition-all md:text-9xl md:ms-10 group">
          ...
          <p className="md:ms-10 text-xs sm:w-[60%]  opacity-50 mb-8 hover:text-[#3efb5a] transition-all">
